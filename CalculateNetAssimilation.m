...
%Eidata_8=importdata('Einput_potato_280_RSA.txt'); % Load calibrated enzyme activity levels for potato
...
Eidata_15=importdata('Einput_potato_420_RSA.txt'); % Load calibrated enzyme activity levels for potato
