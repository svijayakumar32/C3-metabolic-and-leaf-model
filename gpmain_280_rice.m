...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%function gpmain_280_potato(Ci, output)
global Vrubusco_adj;
...
%         file=fopen('outputenz_280_potato.txt','w');
%         fprintf(file,'%.4f\n',BestMatrix);
        writematrix(BestMatrix,'Einput_rice_new.txt');
        writematrix(d_plot,'d_plot_280_ini_rice.xls');
        save CO2_280_rice-new;
    end
	%Save workspace
	%save output_rice_280_new;
  end
