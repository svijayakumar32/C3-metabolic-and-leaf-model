...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%function gpmain_potato_129(Ci,CO2_potato)
global Vrubusco_adj;
...
%           Eiopop(12)=Eio(12);%VATP synthesis not used
            ...
            % from starting enzyme levels in Einput_potato
...
%             Temp=EPS_Drive_GRNs(Einput,CO2i,PPFDi,WeatherTemp,GRNC,0,Eiopop_phot);
    ...
    %xlim([1, i+1]); ylim([0,80]);  
	   ...
	   if rem(i/100,1)==0
        i
        save CO2_potato_129_0.01_New_1.mat;     
%       Save matrix of optimal enzyme rates to output file
        BestMatrix=BestMatrix';
        writematrix(BestMatrix,'outputenz_129_potato_0.01_New_1.txt');
        writematrix(d_plot,'d_plot_129_potato_0.01_New_1.xls');
       end
end