...
Eidata_1=importdata('Einput_potato_140.txt'); % Load calibrated enzyme activity levels for potato
...
%Eidata_15=importdata('Einput_potato_420.txt'); % Load calibrated enzyme activity levels for potato
