...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%function gpmain_new_rice(Ci, output)
global Vrubusco_adj;
...
Edata=importdata('Einput_rice_new.txt');%updated rice enzyme levels at 280
Eio=Edata.data(:,1);
...
%         fprintf(file,'%.4f\n',BestMatrix);
        writematrix(BestMatrix,'outputenz_129_rice_new.txt');
        writematrix(d_plot,'d_plot_129_rice_new.xls');
        save CO2_129_rice_new;
    end
	%Save workspace
	%save output_rice_129_new;
  end
