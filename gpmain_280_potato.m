...
global Vrubusco_adj;
Vrubusco_adj=0.7; %keep as 1.0 after fixed optimization
global VmaxAdj;%
VmaxAdj=2.1;
...
%         fprintf(file,'%.4f\n',BestMatrix);
        writematrix(BestMatrix,'Einput_potato.txt');
        writematrix(d_plot,'d_plot_280_ini_potato.xls');
        save CO2_280_potato;
    end
	%Save workspace
	%save output_potato_280;
  end
