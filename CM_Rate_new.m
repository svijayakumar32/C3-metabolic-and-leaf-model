...
%% %% MOD 1 Adjust EnzymeAct indices to correspond with EPS_Drive GRNs
%%i.e.comment out V16
...
%% %% MOD 2 Adjust EnzymeAct indices to correspond with EPS_Drive GRNs
%%i.e.comment out V16
...
%% MOD 3 Adjust EnzymeAct indices to correspond with EPS_Drive GRNs
global V111;
global V112;
global V113;
global V121;
...
PrV1T = V1T;
PrV2T = V2T;
%% MOD 4 Adjust EnzymeAct indices to correspond with EPS_Drive GRNs
global 	V51	;
global 	V52	;
global 	V55	;
global 	V56	;
...
%% MOD 5 Adjust EnzymeAct indices to correspond with EPS_Drive GRNs i.e. remove V16
...
%% MOD 6 Adjust EnzymeAct indices to correspond with EPS_Drive GRNs i.e. remove V16
PS2EPS_V16=v16;
%%
...
%% MOD 7 Adjust EnzymeAct indices to correspond with EPS_Drive GRNs i.e. remove V16
% CMr = zeros(15,1);
CMr = zeros(16,1);
...
CMr(10)	=	v10	;
CMr(11)	=	v13	;
%% MOD 8 Adjust EnzymeAct indices to correspond with EPS_Drive GRNs i.e. remove V16
CMr(12)	=	v16	;
% CMr(12)	=	v23	;
% CMr(13)	=	v31	;
% CMr(14) =   v32;
...
%% MOD 9 Adjust EnzymeAct indices to correspond with EPS_Drive GRNs i.e. remove V16
% CMr(16) = v111;
% CMr(17)= v112;
% CMr(18)= v113;
% CMr(19)= v121;
...
% Assign table
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% MOD 10 Adjust EnzymeAct indices to correspond with EPS_Drive GRNs i.e. remove V16
% CMr(26)	=	v51	;%	DHAP+GAP --FBP
% CMr(27)=	v52	;%	FBP --F6P + Pi
% CMr(28)=	v55	;%	G1P+UTP --OPOP+UDPG 
% CMr(29)=	v56	;%	UDPG+F6P--SUCP + UDP
% CMr(30)=	v57	;%	SUCP--Pi + SUC
% CMr(31)=	v58	;%	F26BP--F6P + Pi
% CMr(32)=	v59	;%	F6P + ATP --ADP + F26BP
% CMr(33)=	v60	;%	ATP+UDP --UTP + ADP
% CMr(34)=	0	;%	POPO --2PO
% CMr(35)=	v62	;%	SUC SINK 
% CMr(36)=	vdhap_in	;%	DHAP IN
% CMr(37)=	vgap_in	;%	GAP Export from chloroplast
% CMr(38)=	vpga_in	;%	PGA export from chloroplast
% CMr(39)=	vpga_use	;%	PGA utilisation in cytosol
% CMr(40)=	vatpf	;%	ATP synthesis rate
